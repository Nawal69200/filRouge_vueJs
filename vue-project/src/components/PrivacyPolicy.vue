    ...
    <div class="row my-5">
      <div class="col-lg-8 mx-auto">
        <div class="bg-light p-4 rounded shadow-sm">
          ...
          <p>
            Bienvenue sur le site Recettes X. Nous attachons une grande importance à la
            confidentialité de vos informations personnelles et cet avis décrit nos pratiques
          ...
          <p>
            Nous ne vendons, n'échangeons ni ne transférons vos informations personnellement
            identifiables à des tiers. Cela n'inclut pas les tiers de confiance qui nous aident
            à exploiter notre site Web, tant que ces parties conviennent de garder ces informations
            confidentielles.
          </p>
